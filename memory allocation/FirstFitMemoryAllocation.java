...
public class FirstFitMemoryAllocation {
    ...
    public FirstFitMemoryAllocation(int[] sizes) {
    ...
    public void allocate(int requestSize) {
        for (MemoryBlock block : memoryBlocks) {
            if (block.isFree && block.size >= requestSize) {
                block.isFree = false; 
                System.out.println("Allocated " + requestSize + " MB in a block of " + block.size + " MB.");
                return;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        FirstFitMemoryAllocation memoryAllocation = new FirstFitMemoryAllocation(sizes);
        while (true) {
            System.out.println("\nMenu:");
